...
import {
  ...
  loadShadersRaw,
  loadShaders,
} from "./lib/glNoise/build/glNoise.m.js";

import {
  CustomShaderMaterial,
  TYPES,
} from "https://cdn.skypack.dev/three-custom-shader-material";
import * as dat from "https://cdn.skypack.dev/dat.gui";

import { MultipassShaderHelper } from "./build/MultipassShaderHelper.cdn.js";
...
(async () => {
  ...
  render(0, () => {
    ...
    if (material && material.uniforms) {
      const { positionField, velocityField } = gpu.allVariables;
